            ...
            <div className="w-full max-w-md fade-in">
                <div className="card-glass p-8">
                    <div className="text-center mb-6">
                        ...
                        <p className="text-muted text-sm mt-1">We&apos;re so excited to see you again!</p>
                    </div>

                    <form action={handleSubmit} className="space-y-4">
                        {error && (
                            <div className="p-2.5 rounded-md bg-danger/10 text-danger text-sm text-center">{error}</div>
                        )}
                        ...
                        <Link href="/forgot-password" className="text-xs text-accent hover:underline block">Forgot your password?</Link>
                    ...
                    <p className="mt-5 text-sm text-muted">
                        Need an account?{' '}
                        <Link href="/signup" className="text-accent hover:underline">Register</Link>
                    </p>
                </div>
            </div>
        </div>
